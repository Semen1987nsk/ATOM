...
В коде Empirik было **4 копии** парсера этой структуры (`market_service.py:172, 226, 397` + `moex_service.py:111`). Каждая копия — потенциальная точка для расхождения логики.
