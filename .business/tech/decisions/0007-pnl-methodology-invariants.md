...
Eqio показывает пользователю P&L в нескольких местах (дашборд, журнал, позиции, графики), и **журнал не сходится с реальным движением денег** — это **главный класс багов** в проекте. Симптомы — расхождение journal vs cash в 100×, equity curve с "обрывами", дашборд показывает -10M₽ при балансе 50K₽.
