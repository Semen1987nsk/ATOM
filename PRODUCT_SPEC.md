# Empirik: Product Specification & User Journey

## 1. Концепция Продукта
**Empirik** — это интеллектуальная экосистема для трейдеров, объединяющая функции торгового дневника, аналитической платформы и риск-менеджера.
...
*   Empirik автоматически подтягивает историю сделок за последний год.

*Вариант Б: Полуавтоматический (CSV)*
*   Пользователь выгружает отчет из терминала и перетаскивает файл в Empirik.
...
2.  Empirik подсвечивает **SQN**: "Твоя система имеет рейтинг 2.5 (Средне)".
...
2.  Вводит стоп-лосс.
3.  Empirik говорит: "Входи объемом 0.15 BTC".
