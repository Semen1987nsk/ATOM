...
export const metadata = {
  title: 'Политика конфиденциальности | Полистата',
  description:
    'Политика обработки персональных данных в Полистата в соответствии с 152-ФЗ.',
};
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <article className="prose-empirik space-y-8 text-[15px] leading-relaxed">
          <section>
            ...
            <p>
              Оператором персональных данных (ПД) является сервис Полистата
