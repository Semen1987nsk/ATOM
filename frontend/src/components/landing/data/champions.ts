...
export const CHAMPIONS_OUTRO = {
  lead: "Они выводили это годами — вручную, по вечерам, в блокнотах.",
  body: "Полистата ведёт тот же учёт за вас: MAE/MFE из свечей MOEX, R-кратность, паттерны входов и повторяющихся ошибок — считаются сами, после каждой сделки.",
  punchLead: "Дисциплина чемпионов —",
  punchAccent: "теперь по умолчанию.",
} as const;
